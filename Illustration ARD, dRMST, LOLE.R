...
ggsave(filename="C:/Users/carol/OneDrive - Erasmus MC/Dissertation/Figures General Introduction/Illustration.png",
       width=15, height=5,
       grid.arrange(ARD.plot, dRMST.plot, LOLE.plot, ncol=3))

# Generate plot for ARD, dRMST, and LOLE
ggsave(filename="C:/Users/carol/OneDrive - Erasmus MC/Dissertation/Figures General Introduction/Illustration.tutorial.png",
       width=10, height=5,
       grid.arrange(ARD.plot, dRMST.plot, ncol=2))